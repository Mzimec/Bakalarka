"""A minimal priority heap used to schedule ordered expirations."""
...
class Comparable(Protocol):
    """!
    @brief Ordering protocol required by the priority heap.
    """
...
class Heap[CT: Comparable]:
    """!
    @brief Maintain values in ascending priority order.
    """
