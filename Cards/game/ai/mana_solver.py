...
class PoolManaSolver(ManaSolver):
    ...
    def get_mana_plan(self, mana_req, controller, state):
        """!
        ...
        """
        from ..mana.mana_value import generate_mana_options_from_req_pool
...
class SourceActivatingManaSolver(ManaSolver):
    ...
    def get_mana_plan(self, mana_req, controller, state, *, reserved=frozenset()):
        ...
        """
        from ..mana.mana_generator import ManaGenerator
