...
$Kde \hspace \pi_D(s) \hspace je \hspace distribuce \hspace stavů \hspace ze \hspace stavu \hspace s \hspace pro \hspace balík \hspace D.$
...
Druhý postup, jak získat winrate balíků je simulovat jejich hru a zaznamenávat výsledky.

### Funkce V(s)
Domnívám se, že ideální způsob pro její odhad bude použít Monte-Carlo Search Tree.
